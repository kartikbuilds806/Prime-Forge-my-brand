...
const showcaseProjects = [
  ...
  },
  {
    ...
    description: 'A full-stack productivity SaaS built around single-goal commitment — users can only pursue one active goal at a time, forcing focus over context-switching. Features an AI coach (Gemini-powered), flexible goal durations, and partner accountability.',
    previewGradient: 'from-blue-900/40 via-zinc-900 to-black',
    accentColor: '#3b82f6',
    tags: ['Next.js 16', 'Supabase', 'Gemini API', 'Framer Motion'],
    liveUrl: 'https://one-path-saas.vercel.app/',
  },
  {
    id: 'ecommerce-brand',
