...
import { PhoneCall, Monitor, CheckCircle2, CreditCard, Rocket, Sparkles, ArrowRight } from 'lucide-react';
          ...
          {processSteps.map((item, idx) => (
            <StaggerItem key={item.step} className="h-full w-[78vw] max-w-[290px] shrink-0 snap-center md:w-auto">
              ...
              >
                ...
                <div className="pt-4 mt-auto flex items-center gap-1 text-[11px] font-semibold text-zinc-400 group-hover:text-white transition-colors">
