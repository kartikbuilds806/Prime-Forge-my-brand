  ...
  return (
    <div className="w-full max-w-5xl mx-auto my-12 md:my-16 px-4">
      <div className="text-center mb-8 md:mb-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs sm:text-sm font-medium mb-4">
        ...
        <p className="text-text-body text-sm md:text-lg max-w-2xl mx-auto">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-zinc-950 via-zinc-900 to-black p-5 sm:p-8 md:p-10 flex flex-col justify-between">
          <div className="flex justify-between items-start gap-2">
            ...
            <div className="flex items-center gap-1.5 bg-black/60 backdrop-blur-md px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-lg border border-white/10 text-[10px] sm:text-xs text-zinc-300">
        ...
        >
          <div className="w-[calc(100vw-2.5rem)] max-w-5xl h-full flex flex-col justify-between">
            <div className="flex justify-between items-start gap-2 pr-6">
              ...
              <div className="flex items-center gap-1.5 bg-black/60 backdrop-blur-md px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-lg border border-white/10 text-[10px] sm:text-xs text-zinc-400">
        ...
        >
          <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-white text-zinc-950 font-bold text-xs flex items-center justify-center shadow-lg border-2 border-zinc-950 hover:scale-110 active:scale-95 transition-transform">
            ↔
          </div>
        </div>
      </div>
