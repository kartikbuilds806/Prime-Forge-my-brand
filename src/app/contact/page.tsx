  ...
  return (
    <div className="flex flex-col container py-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
        ...
        <FadeLeft>
          <div className="bg-surface border border-white/10 rounded-[32px] p-8 md:p-12 h-full">
            <h2 className="text-2xl text-white font-serif mb-8">Direct Contact</h2>
          
          <div className="space-y-8">
            <a href="tel:+918533925291" className="flex items-center gap-6 group">
              <div className="w-14 h-14 bg-white/5 border border-white/10 rounded-full flex items-center justify-center text-white group-hover:bg-accent group-hover:border-accent transition-colors">
                <Phone className="w-6 h-6" />
              </div>
              <div>
                <p className="text-sm text-text-body mb-1">Call us directly</p>
                <p className="text-xl text-white font-medium group-hover:text-accent transition-colors">+91 8533925291</p>
              </div>
            </a>

            <a href="https://wa.me/918533925291" target="_blank" rel="noopener noreferrer" className="flex items-center gap-6 group">
              <div className="w-14 h-14 bg-white/5 border border-white/10 rounded-full flex items-center justify-center text-white group-hover:bg-green-500 group-hover:border-green-500 transition-colors">
                <MessageCircle className="w-6 h-6" />
              </div>
              <div>
                <p className="text-sm text-text-body mb-1">Chat on WhatsApp (Fastest)</p>
                <p className="text-xl text-white font-medium group-hover:text-green-500 transition-colors">+91 8533925291</p>
              </div>
            </a>

            <a href="mailto:primeforge7@gmail.com" className="flex items-center gap-6 group">
              <div className="w-14 h-14 bg-white/5 border border-white/10 rounded-full flex items-center justify-center text-white group-hover:bg-blue-500 group-hover:border-blue-500 transition-colors">
                <Mail className="w-6 h-6" />
              </div>
              <div>
                <p className="text-sm text-text-body mb-1">Email us</p>
                <p className="text-xl text-white font-medium group-hover:text-blue-500 transition-colors">primeforge7@gmail.com</p>
              </div>
            </a>

            <div className="flex items-center gap-6">
              <div className="w-14 h-14 bg-white/5 border border-white/10 rounded-full flex items-center justify-center text-white">
                <MapPin className="w-6 h-6" />
              </div>
              <div>
                <p className="text-sm text-text-body mb-1">Location</p>
                <p className="text-xl text-white font-medium">Dehradun, Uttarakhand, IN</p>
              </div>
            </div>
            </div>
          </div>
        ...
        <ScaleIn delay={0.2}>
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="mt-8 pt-8 border-t border-white/10">
              <p className="text-text-body text-sm mb-4">Ready to bypass the call and dive right in?</p>
              <Button href="/start-a-project" variant="secondary" className="w-full">
